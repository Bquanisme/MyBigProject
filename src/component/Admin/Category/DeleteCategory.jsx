...
import { deleteCategory, getAdminCategory } from '../../../Redux/ReduxAuth/Slice/adminSlice'

const DeleteCategory = ({ selectedIds, setSelectedIds }) => {
  ...
  const handleDelete = () => {
    ...
    try {
      dispatch(deleteCategory(selectedIds))
