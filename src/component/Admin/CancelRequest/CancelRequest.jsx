...
import { getAdminRequestCancel } from '../../../Redux/ReduxAuth/Slice/adminSlice'
import TableCancelRequest from './TableCancelRequest'
...
const CancelRequest = () => {
  ...
  const cancel = useSelector(state => state.admin.requestCancelAdmin)

  const filteredData = cancel.filter(order => {
  ...
  useEffect(() => {
    dispatch(getAdminRequestCancel())
  }, [dispatch])
    ...
    <Box 
      ...
      <Box sx={{display: 'flex', flexDirection: 'column', gap: 10}}>
        ...
        <Box sx={{gap: 2, display: 'flex', flexDirection: 'column'}}>
          <Typography variant='h6' sx={{color: '#353333ff'}}>Name order</Typography>
