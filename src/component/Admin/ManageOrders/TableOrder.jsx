...
export default function TableOrder({paginatedOrder}) {
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow sx={{bgcolor: '#f5f5f5'}}>
            ...
            <TableCell sx={{fontSize: 15, fontWeight: 'bold'}} align="left">UserID</TableCell>
        ...
        <TableBody>
            {paginatedOrder && paginatedOrder.map((row) => (
                <TableRow
                key={row?.id}
                ...
                <TableCell align="left">{row?.user_id || 'null'}</TableCell>
                ...
                <TableCell align="left">
                    <EditOrder id={row?.id} status={row?.status}/>
                </TableCell>
                </TableRow>
            ))}
        </TableBody>
